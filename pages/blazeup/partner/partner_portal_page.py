...
Mirrors the pattern in ``pages/blazeup/admin/login_page.py``:
    locators/blazeup/partner/  → selectors (data)
    pages/blazeup/partner/     → actions  (this file)
    tests/blazeup/ui/  → scenarios

Usage in a test::

    from pages.blazeup.partner.partner_portal_page import PartnerPortalPage
...
from locators.blazeup.partner.partner_portal_locators import PartnerPortalLocators
