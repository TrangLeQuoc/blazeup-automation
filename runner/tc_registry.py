...
TC_REGISTRY: dict[int, TestCase] = {
    1: TestCase(1, "api", "auth", "POST /auth/login returns 200 and JWT token.", "tests/api/test_auth_api.py", "test_tca01_login_returns_jwt_token", ['smoke'], "P1"),
    2: TestCase(2, "api", "auth", "POST /auth/login with wrong password returns 401.", "tests/api/test_auth_api.py", "test_tca02_login_wrong_password_returns_401", [], "P2"),
    ...
    4: TestCase(4, "api", "auth", "GET /auth/me returns authenticated user information.", "tests/api/test_auth_api.py", "test_tca04_get_me_returns_user_info", ['smoke'], "P1"),
    ...
    7: TestCase(7, "api", "attendance", "POST /attendance/clock-in returns 200 and timestamp.", "tests/api/test_attendance_api.py", "test_tca07_clock_in_returns_timestamp", ['smoke'], "P1"),
    ...
    11: TestCase(11, "api", "attendance", "GET /attendance/today returns current status.", "tests/api/test_attendance_api.py", "test_tca11_today_attendance_returns_current_status", ['smoke'], "P1"),
